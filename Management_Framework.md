...
The Profile is a foundational *conceptual* structure that can be used by Managers at all levels. It is based on academic resources, industry standards, as well as own experience. Resources are cited where relevant.  
________________________________________
## Profile Overview
...
Leading involves *driving* those *who perform Operations* by directing, influencing, inspiring, and motivating individual Staff,  Groups and Suppliers to achieve Objectives. Leading consists of establishing a *Safe Space* such that *collaboration*, *motivation*, *inspiration*, and *learning* are all maximised. Leading involves *Networking* and also grooms *future Managers* and, Leading reflects upon one-self as Manager through *Management Improvement*. Lastly, Leading aims at achieving a *Culture* which embeds the Values from Planning. The Manager achieves all these deliverables through *Interaction* with individual Staff, Groups and Suppliers using various means.
...
It is worth noting that the Profile is a simplification of complex concepts that have many properties and which are often implemented in complex Venture structures. Additionally, the proposed structure in the Profile is a *possible* way of looking at a Corporation, it is certainly not the only way. Nevertheless, the simplification helps see the trees in the forest, and helps focusing on the fundamentals of what a Venture is ultimately about.  
  
Notes:  
- Environment impacts every aspect of the Venture.  
...
The Profile Tree can be assessed in different manners each enforcing a different understanding of a Venture. These alternative ways are discussed below. 
  
### Profile Tree Top and Bottom
Another way to understand the Profile Tree is to break it down into two parts: *Top Profile Tree* and *Bottom Profile Tree*, indicated by the two blocks between the dashed lines in above diagram. The Top Profile Tree is outward focused and says:  
...
The Bottom Profile Tree is inward focused and says:
...
________________________________________
## Tools
Management Tools or in short Tools aid Managers in the performance of Management. Although Tools is a deliverable within Management, covered later in this note, it appears here because of how the concept is defined and what it is composed of. It is worth noting that "tools" are of course used everywhere including in Operations, to aid in the performance of Run and Change e.g., a wrench, software, printer, etc. However, those tools are deemed Assets. In other words in the Management Framework, Tools means Management Tools and it refers to any Tool used as part of Management. If such tools can also aid elsewhere in the Profile Tree, even better. 
...
### Research
Research is the result of reading, watching, or listening to different sources of information to enhance the manner in which a Manager performs his role. Sources include academic literature, books, newspapers, articles, documentaries, blogs, podcasts, etc. The vast majority of research is nowadays available online. Research also includes Networks built by a manager which includes recurring or ad hoc interactions with other Managers, alumni, peers, industry groups and individuals or groups that have exposure to Management.
  
### Framework
A Framework is a conceptual structure intended to support a specific aspect of one or more Management Functions' Processes. It acts as a guideline that helps Managing a topic without being specific about Processes involved in it. Acting more as guidelines Frameworks are not absolute truths nor do they guarantee specific, reproducible outcomes. Templates are part of Frameworks. This note contains many Frameworks.
...
The Profile is itself a Framework whereas the Profile Tree Items are Definitions. Essential Tools used in the rest of the Management Framework are discussed below:

### Topic Definition
The word Topic is relatively common to not really warrant a definition. However, the Management Framework formalises it nevertheless. A Topic is an idea, subject or theme that is dealt with in written or spoken discourse. The *Topic Scope* is virtually unlimited. Even within the context of Management Framework there are many Topics, and they can multiply fast by refining the context around a Topic. For example, Income can be a Topic, but the Income of a specific Activity is another, even if related Topic. Effectively everything single item in the Management Framework is a Topic. A Topic can fall within a *Topic Category*. For example, Income can be tagged to Finance. However, many Topics are related to more than one Category. For example, Income is related to Income Statement and Corporate Tax. 
...
Output is determined by what is the *desired* Result. Output thus drives the design of the Steps to be applied to the Input. The actual Output may differ of course from what was intended i.e., as a consequence of a faulty Process or an undesirable but unavoidable by-product. Output can be anything from a decision to a physical object. 
...
Above forms all assume Ventures whose main purpose is to increase Profit. There are of course other forms of Ventures with different objectives. For example religious, governmental or state owned institutions and charities. Such Ventures mostly follow the concepts of the Profile Tree: they provide some form of -potentially free- Service through Operations which can be continuously improved through Management. 
...
- Board of Directors (BOD): people elected by Shareholders to represent their interests by setting the strategic direction of the Venture (Strategy) and by monitoring Management's performance in achieving it. The BOD focuses mostly on the Executive level and how their decisions impact the Results of Operations.  
...
- Staff: people who, with the help of Suppliers, and using Assets perform Operations which, if done as planned, yields the Strategy set out by the BOD, and thus satisfying the expectations of the Owners 
  
However, modern Corporate Governance covers a wider scope and includes Managers, Board of Directors, Investors, Auditors, Customers, Suppliers, Unions, Media, Regulators, Analysts and Creditors (Larcker, 2021). Ultimately, albeit difficult to measure, good Corporate Governance decreases the Agency Cost whilst the implementation Cost of such Corporate Governance is less than said Agency Cost. 

### Going Concern
The going concern principle states that a Venture will meet its financial obligations (Liabilities) when they come due, and this without a need to liquidate Activities ir Assets in the foreseeable futures which is generally accepted as one year. In the Management Framework a Venture is deemed to continue as a going concern.
________________________________________
## Environment
...
The Environment has the following Deliverables often referred to as *Environment Dimensions*:  
- Investors & Creditors
...
A single Venture can operate in one or more Sectors. For example Reliance Industries offers services across many of above Sectors.
...
### Politics, Laws & Regulations
Politics represents the governmental and judicial structure, and includes military and the use of military through war as an extension of politics as well as any form of war-like measures without a formal political framing e.g., terrorism. Politics yield Law which dictates formally what is required to be done, or more often expected to be refrained from. Law is overseen and framed by the judicial system as well as a police system aiming to enforce the word of law. Law can be applicable to different aspect of a Venture e.g., employment law (tax law is discussed under Economics & Tax). Regulators establish Regulations, which result from Politics but are narrower in their application i.e., they apply to specific Sectors. They thus have a direct impact on Services and/or Operations and/or an indirect impact through Clients and Suppliers if the Venture operates within such regulated Sectors. The Business Functions Compliance, Risk, and Legal are concerned with these Environmental Dimensions. The externally defined Laws and Regulations are often partially or wholly reflected in Bylaws.
  
### Competitors
Competitors offer similar or the same Services to similar or the same Clients in the same Sector(s) the Venture operates in. They are an integral part of Economics in terms of supply and demand. Competitors offering Services closest to the Venture's Services are called *Peers*. The Business Function Marketing is concerned with this Environmental Dimension.
  
### Climate & Weather 
These includes aspects like temperature, rainfall, humidity, tornadoes, monsoons, drought, etc. Depending on the Business Model of the Venture, several Business Functions can be concerned with this Environmental Dimension. 
  
### Geography & Nature 
Geography includes consequences of the location the Venture operates in and which are not Climate related e.g., soil, volcanoes, risk of earthquakes, tsunamis, etc. Nature refers to the natural plant and wildlife as a result of Climate, Geography and potentially under the impact of Society. Depending on the Business Model of the Venture, several Business Functions can be concerned with this Environmental Dimension. 
  
### Economy & Tax
Economy refers to the supply and demand of goods and Services within a country, as well as the dependency on other countries for such supply/demand. It also includes monetary policy. Tax, although determined by Politics and Law is closely linked to Economics. Tax determines a broad range of taxes applicable to the Venture: profit tax, services tax, stamp duties, but also income tax of Staff salaries, accounting standards and also the fiscal policy maintained in a country. The Business Function Tax is concerned with this Environmental Dimension. 
  
### Society & Culture
Society refers to the total of social forces excluding Politics and Economics that make up a society. It includes aspects like art, cuisine, music, movies, sports, religion, healthcare, demographics, labour unions. Culture is defined as the set of written and unwritten rules for expected behaviour and has an effect from outside as well as within the Venture. Depending on the Business Model, several Business Functions can be concerned with this Environmental Dimension. 
  
### Science & Technology
Science is the pursuit of answering questions in different fields of knowledge (business, physics, biology, chemistry etc). Technology is a practical application of the outcome of Science and is a main driver of innovation. Depending on the business model of the Venture, several Business Functions can be concerned with these Environmental Dimensions. 
  
### Infrastructure
Infrastructure: represents facilities available to the Venture and that support it including access to real estate, energy, telecommunication and transportation including transport of specialist materials like some form of gases or liquids. Depending on the business model of the Venture, several Business Functions can be concerned with this Environmental Dimension. 
________________________________________
## Clients
...
________________________________________
## Services 
Services is a single term used to describe both Goods and/or Services. Goods can be raw materials, finished Products or anything in between. Services are non-tangible output of Operations. Services could be considered a Result. The reason why it is considered on a standalone basis, is that Services is the aspect that is not 'retained' within Operations and Management, but effectively leaves the Venture once it is sold and has generated Revenue. A Service *may* return to Operations, generating Cost as part of post-sales support for example.   
Both Goods and Services are of value to Clients, and they are thus willing to do an effort to obtain them, or for which they will be appreciative in some manner, most often monetary. In certain cases Services can be composed of Services *and* Products. For example, stock exchanges deliver various Products (Stock, ETF, Options, ...) through various Services (Trading, Clearing, Settlement, Market Data, ...) or Computer Hardware companies sell Products (computers) but also offer Services (repair, helpdesk) to support those Products. Some Services are for the benefit of the Venture itself i.e., internal Services like Risk Management, IT Support, etc. Services are expected to be of good *quality* which means a Service should respond *simultaneously* to:
- Client (of internal department) expectations and
- Laws or Regulations
   
Services have various dimensions like desirability, cost, availability, quality etc. Collecting what interests a Client, and reversely making the offering of a Venture attractive to Clients is the remit of Business Function Marketing. 
...
### Change
Change Services consists of Services applied to Run Services such that the Run Services generate more Revenue, and/or protects existing Revenue and/or at lower Cost and/or at lower Risk and/or improve the Reputation of the Venture altogether.
________________________________________
## Operations
...
The main deliverables within Processes are the following:
- Run
- Change 

### Run
The Run, or Run The Organisation a.k.a. Production or Prod, is composed of Processes done in a recurring or continuous manner and which generate Run Services. The name comes from the expression "Running a Business". Recurring can be continuously, hourly, daily, weekly, monthly, quarterly, semi-annually, annually, two-yearly, ad-hoc (triggered), etc. Run is often broken down into two *chains*:
...
The Value Chain represents the Routines that generate Services (directly or indirectly) that are sold to Clients. This should be seen broadly. It includes everything from research and development, production of actual Goods or Services, marketing, sales, after sales. The Control Chain are those Processes that perform Services that verify the results of the Value Chain are as expected. Control should be seen broadly. For example, Control could be a check of the product to make sure it features the expected qualities, or it can be measures taken to assure the Run itself was performed in a manner prescribed by the company Policies.
    
As will be seen later, the name of the Processes performed in Run is *Routines* as they are done *routinely*.

### Change
Change, Change The Organisation or Transformation, consists of Processes performed to improve or transform the Run such as to:
- Grow output to yield more Revenue (more existing, or new, Services);
- Protect existing Revenue at risk of being lost (due to changes in the Environment like new products issued by Competitors, change in laws etc.);
...
The difference between Optimise and the three other Change Types is subtle. If one improves a process such that it yields more Services for the same price has one Grown the Run or Optimised the Run. There is no clear cut rule here, but in general, if the intent is to Optimise then any indirect consequence should not drive the Change Type.
...
There is no fixed ratio between Run and Change for any given industry. At average, in the past it was more around 80% Run and 20% Change. Over time this has shifted to 20/80. There are also extreme cases: some companies have a Business Model based on custom made Products, effectively reducing Routines to nearly 0% and Projects to almost 100% of the modus operandi e.g., custom made furniture or cars. In some companies Operations is deemed Run *including* Projects. Furthermore, some Ventures operate according to composite models like Run-Grow-Transform. 

Processes are the focus of Business Function Operations.
________________________________________
## Resources
Resources are effectively the input and overseers for the Operation's Processes. 
  
There are three fundamental Resources:
- Staff
- Suppliers
- Assets
...
Finding the most relevant Staff with above characteristics, and maintaining them is done by Business Function Human Resources.
...
- Humanities (languages, philosophy, law, history, theology, ...)
- Natural Sciences (physics, chemistry, biology, earth science, ...)
- Formal sciences (mathematics, logic, computer science, ...)
- Social Sciences (business incl accounting, economics, sociology, psychology, ...)
- Applied Sciences (all forms of engineering, medicine, military, education , public administration, artificial intelligence, ...)
- Accounting & Finance
- Project Management 
...
Secondly, pro-activity is to act entrepreneurial i.e., self-initiate Objectives and Goals. Pro-activity focuses on *missing*, *ineffective* or *inefficient* parts of the Venture and includes the capacity to:
- See the bigger picture, being able to zoom-out of Objectives and seeing how Objectives feed into Goals and Goals into the Mission and the Operations overall Results.
- Have a strong focus on final Results rather than only the performance of the Objectives assigned to oneself  
- Understand if and when Results are only partially met and why
- Understand which Objectives and Goals are missing/incomplete such if they were remediated the Results would be achieved.
- Understand Goals of the Venture and how underlying existing Objectives align to that Goal, including Objectives that are not covered by the Staff.
-Ability to see dependencies between Processes and Resources 
...
### Suppliers
Suppliers contribute to the performance of Operations without being accountable for the final Results, but possibly being accountable for intermediate Services. Suppliers can be embedded, internal or external (see below). They include distributors, utilities as well as internal Groups. Suppliers can provide raw materials, finished products, commodities like electricity, water or internet access (considered a commodity nowadays) as well as intangibles e.g., custody, advisory, etc. All these Services produces by Suppliers are deemed Assets and Suppliers are thus closely linked to Assets as they often provide and/or service Assets. The Service and/or Goods to be provided by a Supplier and the commercial terms of that provision are most often bound by some form of contract or service agreement. Although Suppliers are not held accountable for Operations (Management is), they are accountable for producing the Services or Goods they provide. Finding the best Suppliers and maintaining the relationship and contracts is done by Business Function Procurement.  
   
There are two types of Suppliers: *Internal Suppliers* and *External Suppliers*:
- Internal Suppliers: Suppliers within the Venture i.e., a department deemed a Supplier to other Activities in the Venture.
- External Suppliers: the 'classic' Suppliers outside the Venture including consultants.
...
#### Data  
The terms *Data* and *Information* a.k.a. *Info* are often used interchangeably, but they aren't the same. Data, in the Management Framework, is defined as *individual records of fact*, while Info is the *organisation, interpretation and visualisation*, or in short *representation* of those facts *within a relevant context*. However, when talking of Data as an Asset, it assumes both the record of fact as well as the representation of it. In other words, Data in this Framework reflects both Data and Info. The Asset Data is an intangible Asset, but has its own classification given its importance. Data is considered a combination of a physical repository (classified under Infrastructure) and the content held therein. Content can be broken down into two key types: *Structured Data* (spreadsheets, databases,...), and *Unstructured Data* (videos, music, pictures, text, presentations, source code,...). Neither Data nor Info yield truth (an accurate reflection of reality) as such, because both can be subjectively produced (Harari, 2024). However, this note will not expand upon that philosophical debate and stick to the simple premise that Managers have an interest to have Data and Info produced such that it is as accurate as possible, and it is assumed that Managers do this in the best interest of the Venture in the broadest sense.   
    
#### Services  
Unlike the Services provided by the Venture (output of the Venture), Services under Assets refers to Services received by the Venture i.e., *provided* by Suppliers and which are not any of the above e.g., trading venues, catering, cleaning services. Such Services are not recognised as an Asset on the Balance Sheet, but rather generate a Cost on the Income Statement. From an Operations perspective such Services are deemed an Asset as they enable Operations to be performed.  
________________________________________
## Capital
In order to pay for Resources the Venture needs Cash. Cash is obtained through cash from Revenue but is often not available at the time, or in sufficient amount, when required. Overcoming the timing and size differences between needing Cash and sufficient Cash having been generated from Revenue is done through *Financial Capital*, or Capital in short. 
...
### Liabilities
Liabilities a.k.a. Debt is a form of active or passive Funding and consists essentially of different types of Loans. Liabilities are recorded on the right side of the Balance Sheet and are maintained through Business Function Finance, specifically Accounting.
...
#### Short Term Loans  
A short term loan is an active form of funding: borrowing money to return shortly (days, weeks). Because they are short term there are often less conditions involved. 
...
The Processes involved in issuing shares is discussed in Financing later in this note. Generally speaking, a Manager, in particular at higher levels, is expected to understand the relationship between Assets, Liabilities, Equity and Profitability as well as the different forms of Equity and how they help maintain a financially healthy Venture.
________________________________________
## Results
There are four key results from the performance of the Processes in Operations. Out of the four Revenue is the reason why Venture's exist in the first place (at least for commercial Ventures). Two other monetary Results are Cost and Risk and they are undesired, but unavoidable, consequences of performing Processes using Resources within the constraints imposed on the performance of the Processes, mostly from the Environment. The fourth result is intangible and non-monetary: Image. 
   
### Revenue
Revenue is the principal result of the Run. A good understanding of Revenue drivers and their evolution as well as future expectations of Revenue is key to Management. Although the core activity of a Venture is to generate Revenue from the Run, other forms of Revenue can occur. For example the sale of an Activity may yield Revenue, but will also subsequently yield a loss of Revenue the Activity generated. Revenue is often net of Cost Of Good Sold or other contra revenues, see below. Revenues are recorded on the Income Statement and are maintained through Business Function Finance, specifically Accounting.
  
### Cost
Operations create Cost in different forms:
...
- Taxes: most often income is taxed at some corporate rate. Profit is often assessed at different Cost levels i.e., pre-tax and after-tax. Tax is covered by Business Function Tax.
...
Ultimately, the adverse outcome can be any or all of the following:
...
- Reputational risk: a.k.a. Franchise Risk is the risk that the Image of a Venture is damaged with the result that Clients seek their Services elsewhere. Reputational Risk can be as a result of the Venture itself, but also, indirectly as a result of the actions of one or more Staff in the Venture, or alternatively through Suppliers.  
...
### Reputation 
The Reputation or Image of a Venture is a non-monetary but often crucial Result of conducting Operations. A Venture's Reputation relates to how Stakeholders, and thus *any people* in the Environment and in the Venture itself *perceive* the Venture as a whole against a wide possible range of metrics relevant to any of those people, like aesthetics of Services, general reliability of the Services, reliability of the Venture on making good on its contractual obligations or on its ability to deliver value to its owners. It also includes aspects not directly linked to the Services offered like whether the Venture takes care of its employees or whether it cares for the climate or environment, whether it has involvement in financing or otherwise enabling criminal, terrorist, or other malicious entities, etc. There is no well defined scope for Reputation nor is it easy to measure. However, the notion of Reputation is important to a Venture, and it is possible that a poor Reputation can break the Venture over time whereas at the same time, a good one can temporarily make up for poorer Services from the Venture for example.  
The Venture's Reputation is the focus of Business Function Communications and possibly Marketing. 
________________________________________
## Management
...
### Management Level   
A *Management Level* indicates at what level within the organisation Management is performed. Top Management is Management of the entire Venture often represented through so called *C-suite* roles (Chief Executive Officer, Chief Operating Officer, Chief Financial Officer, etc) particularly if it is an incorporated company. Middle Management involves the running of Activities on department or country level, whereas Low-level Management or Line Management relates to teams close to the Processes being performed. Obviously, more granular Management Levels are possible. Ultimately, Top Management effectively delegates (see Organising further below), a vast amount of Management Functions to Middle Management and they in turn delegate to Line Management. At each level Management still consists of the four Management Functions, but the lower the level, the more the functions focus on Short Term and Operational aspects and less on Strategic aspects.   
For lower levels Management may not be a full time job, instead it is part of the job, and the Manager may be involved in parts of Operations. This is referred to as a *hybrid Management/Operations* role or a *Hybrid Manager*. Last but not least, the concepts of Management can be used by Directors of the Board of Directors, see under [## Venture].  Reversely, the Corporate Governance aspects discussed earlier apply more or less to the different Management Levels.
Another way of looking at this, is that Top Management *defines*, Middle Management *designs*, and Lower Management*develops*.
...
Always keep the Results (Revenue, Cost, Risk, Image) within the constraints of the Environment as the driving force of the Venture. In other words, if a Goal, Objective, Task or more generally any Process does not increase Revenue, and/or reduce Cost and/or decrease Risk and/or improve the Image, then that Process should probably not be performed. The exception to this is if said Process is needed to inform Stakeholders of the Results or the manner in which these Results are achieved.  
  
#### Management Principle - Keep it Simple
Complexity is a Cost, and it in addition, it can stun the flexibility the Venture has to deal with Change and to innovate. Complexity often creeps in over time and even if the direct costs of such complexity is difficult to gauge, Managers should thrive in eliminating complexity in all its forms. This includes simplicity in the organisation (echoing Fayol's unity of command).

### Management Approach 
As per the Profile, Management has several components:  
- Planning
- Organising
- Leading
- Controlling
...
These Management components each have a dedicated section below, except Tools which was already discussed earlier.
________________________________________
## Planning
...
This Management Function defines why the Venture exists and which Services need to be delivered now and in the future, in which location and for which Clients as well as how this needs to be achieved. It has a strong focus on the Processes part of Operations.
  
Planning as a Management Function is practically speaking for a large part done by the Manager in isolation. 
...
### Values
Values reflect what the Venture deems its moral or cultural compass. It can be composed of Values *and* Principles. These are somewhat different in what they mean. Values focus on how to 'be' whereas principles focus on how to 'act' or 'what to do'. Values are opinions and ideas and are thus subjective, and as a result, they can change under different conditions. Principles govern interactions between people, but are more objective. 
...
### Bylaws
Bylaws also referred to as the more holistic *Rules*, represent a broad range of texts that frame the *conditions* under which the Venture *must* operate and how it *must* organise itself. Bylaws represent the Venture's interpretation of laws, rules, regulations and possibly also guidelines imposed by the Environment and which effectively provide *boundaries* on Services and Operations. They result from the Venture operating directly or indirectly in one or more Countries with corporate and tax laws and Sectors that are regulated globally and/or nationally. In addition, Ventures can themselves define rules with regards to what it deems the Venture should comply with even if this is not mandated by any official institution. Often, such Venture imposed rules will also embody the Values mentioned above. The definition of Bylaws is a result from the SWOT process, see below.
  
Examples of Bylaws are Articles of Association, Company Laws, Company Policies, Company Rules, Sector Regulations, etc.  
  
Obtaining knowledge, and interpretation of applicable laws, rules and regulations is part and parcel of Bylaws. This is often achieved through Business Functions:
- Compliance: regulations specific to the Sector the Services are delivered in
- Risk: laws or regulations w/r to Risk if applicable 
- Legal: corporate law, environmental law
...
### Goals 
Goals, sometimes referred to as Pillars are outcome statements that define how the Venture is trying to accomplish its Mission and how it tries to align the Mission to the Vision over time. Goals are most often expressed in terms of Revenue, Cost and Risk, and thus indirectly the Services it aims to deliver through Operations. Goals are the overarching driver for Objectives. Goals have the following properties:
...
1. What: Unambiguous and measurable, reflected by a name or description of the Objective that starts with a *verb* which gives a high-level indication of what is the Result of the Objective once completed: "Create ...", "Build ...", "Repair ...", "Study ...", "Onboard ...", "Write ...", etc.
...
### Tasks
Tasks are similar to Objectives but on a smaller scale i.e., there are Tasks that are more like Routines and Tasks that are more like Projects. Tasks can also be used to reflect specific Processes within Routines or Projects without necessarily breaking those down in Subs/Streams and Drills/Actions. Alternatively, Tasks can also reflect work to do without being specific on whether it is an Objective or whether it is part of a Goal or whether it contributes to a Service. 
...
### Operational Plan
An Operational Plan a.k.a. Operating Model describes *how* the Tactical Plan, or in absence of it, the Strategic Plan, is achieved. More specifically, it explains *how* and *when* Assets and Suppliers are used by Staff to achieve both Run and Change Goals through the realisation of specific Objectives, generating Services ultimately yielding Reputation , Revenue at Cost and Risk. An Operational Plan contains often *all* aspects of the Profile Tree from Environment to Operations. As the focus is on the aspects of Operations, items like Mission, Vision, Values are often omitted but can, if desired, be included. Benchmarks may or may not be integrated in this plan. The level of detail of an Operating Model can be high, for example it can contain details of how Staff communicate, how they are organised in terms of seats, how requests are managed, how infrastructure is implemented, how that infra is supported, how Staff is trained, etc. The level of detail can also vary by Activity.   
As a result of being all encompassing, the Operational Plan cannot be defined before Organising, Leading and Controlling, but instead is defined iteratively throughout Management. The Operational Plan can take in details from the various business functions e.g., details of supply chain from Procurement. The Operational Plan should also include the concept of resilience which is the Venture's ability to withstand abrupt or dramatic changes in its Environment yet still function. As such, the Operational Plan is truly a blueprint of Operations of the entire Venture. The Operational Plan feeds into the SWOT as the most detailed level of the Venture's internal workings. Lastly, the Operational Plan also explains how Management assures the continuity and optimisation of Operations.
...
#### Venture Intel
Venture Intelligence, Venture Intel or Internal Intel represents any form of Intel generated *within* the Venture. This goes across all internal aspects of the Profile Tree i.e., everything except for the Environment. It thus includes Intel obtained from Staff, Groups, Suppliers and Management and of course the Business Functions.
...
2. Insight in the positioning of the Venture in the market it operates in.
...
________________________________________
## Organising
Organising establishes *how to do it* as in, how to do what was determined in Planning *and* being able to sustain it financially. It is forward looking in its approach. Within Operations, Organising broadly structures Resources and Capital to fit the Plan. In other words, Organising defines how Staff, Assets and Suppliers are organised and assures Capital is well-structured and available to deliver the Strategy defined in Planning. The result is an Organisation in which Staff know what to do and how, using Assets and Suppliers funded by sufficient Capital. Organising has a strong focus on the Resources and Capital part of Operations. 
...
Sometimes an Activity is transverse i.e., it provides an Output used as Input to other Activities.  
...
1. The act by which a *Delegator* (often a Manager)
2. gives *Responsibility* for *completion of a Process* to 
3. a suitable *Delegatee* (Staff), including 
4. the *Authority* that goes with said Responsibility 
5. which bestows upon the Delegatee an *Accountability* to the Delegator for the Result of said Process, yet
6. without the Delegator losing the original *Accountability* which  
7. requires *Oversight* from the Delegator over the Delegatee and over the Result.
  
The singular *Process* above can be read as an Objective, an Activity or the entire Venture. Specifically, *Responsibility* relates to *performing and completing a Process* to *obtain a Result*, whereas *Accountability* relates to *reporting on and being subject to the consequences* of that Result being as *expected*, or *not*!  
   
The Responsibility to perform a Process requires Authority which is the power or right to give orders and expect them to be obeyed (exact obedience), to commit Resources (Staff, Assets, Suppliers), and to make decisions. Clearly defined Authority is key in the ability to achieve the Result expected from the Responsibility of performing a Process. This goes two ways: 
...
Once Responsibility has been Delegated, the Delegatee is automatically bestowed with the Accountability to *discharge the Responsibility* i.e., for the delivery of the Result of the Process. As mentioned, Accountability means one is liable to report to someone (Manager, CEO, Board of Directors, Shareholder, etc.) on the Result, including timeliness, of a Process and face some form of consequence if it is not achieved, and some form of praise if it is. Note that one can delegate Responsibility and Authority, but one *cannot* delegate Accountability! In other words, a Delegator *can* delegate Responsibility (and the Authority that goes with it), from which automatically flows the fact that the Delegatee owes Accountability to the Delegator. However, a Delegator *cannot* delegate that Accountability on a standalone basis i.e., cannot make a Delegatee accountable for a Process for which the Delegator has *not* delegated Responsibility nor Authority to the Delegatee. This makes sense: being held liable for something over which one has no influence, and provides no direction would be unfair, and legally impossible.
...
#### Roles
The Role of a Staff is indicative of two key aspects from the concept of Delegating discussed above: Responsibility and Authority. The Role is most often formalised with a combined *Job Title* and *Corporate Title* a.k.a. *Business Title*.  
A Job Title is a short label indicating what type of Processes (or Objectives or entire Activities) the Role is responsible for and potentially what type of Authority goes with that e.g., "Head of Design".   
A Corporate Title implies seniority in that Role as well as Authority that comes with it e.g., Associate, Vice President, Senior Vice President, Director, Managing Director, President, etc.   

A Role helps convey an overall idea of the level of Responsibility delegated to the Staff for a specific or broadly defined functional scope. In addition, it helps defining what type of Responsibilities can be delegated to Staff holding that Role. This is particularly useful for Managers. It is possible to have more than one Role within a Group or across Groups! A well defined Role contains both Job Title and Corporate Title, and it also explains in just a few words the Responsibilities from a high level. 
...
### Casting
Casting is the Process of finding or allocating the right individual for a given Role, or finding a suitable Supplier for an Activity. In other words, it is about finding "the right fit". This deliverable is sometimes also called *Resource Allocation* or more crudely *Hiring & Firing*. Casting is complex because not only do the actual Roles & Responsibilities (or entire Activities in the case of Suppliers) need to be considered, but also other aspects that are less well defined. Notably the Casting of Managers is more difficult, as they need to portray various Skills implicit to a Management function.  
  
### Funding
Funding is the Process of assuring Capital is available to fund the Resources. It is an important aspect of starting a Venture but also to continue the Venture, also known as the *going concern* principle. For Top Management level this involves decisions on relation to issuing shares, buying back shares, issuing debt etc. For Middle Management this is more about assuring the right amount of Capital is allocated to the Activities they oversee. For Line Management the notion of Funding may or may not exist, and is often mostly focused on making sure Middle Management is aware of funding needs. Funding at Line Management level is sometimes expressed in terms of manpower instead of Capital. Funding can be seen as part of the Business Function Finance, specifically the deliverable Financing. However, where Financing provides advice on most optimal structures to fund the Venture, Funding under Organising ultimately assures sufficient Capital is available to fund the Resources. It is worth noting, that Funding also includes the decision to not Fund i.e., to not Grow or partially Grow (part of) the Operations, or not or partially Optimise (part of) the Operations, etc.  
________________________________________
## Leading 
...
### Inspiration
Unlike Motivation, inspiration is the Process of influencing Staff emotionally and mentally to be *creative*. As such, Inspiration is a key deliverable to yield Change. In fact, rather than asking for a specific Change through Motivation, Manager's can generate Change, without asking, by Inspiring. It is the responsibility of the Manager to assure Staff is inspired throughout the lifetime of the Venture.
  
### Learning
Any Venture will undergo Change and in order to accommodate that the entire Venture often needs to learn new aspects of one or more items of the Profile Tree. Often this relates to Technology, which grows at a fast pace, but it also includes changes in Management theory, including Leading. More broadly, Learning consists of any form of *knowledge acquisition* that is beneficial to Staff as individuals and the Venture as a whole. Managers need to assure that Staff and Groups are in a position to acquire knowledge in relation to their Roles & Responsibilities, but are also in a position to learn such as to prepare them for growth within the Venture.
...
### Culture 
The Culture of a Venture reflects the Values the Venture aims at achieving. Culture often grows organically, but it can be and most often is also cultivated through Leading. This is achieved through leading by example, story telling, reinforcement, training etc. The bottom line is that Leading also aims to achieve and reinforce the Venture's culture.

### Interaction
An Interaction in Leading is a form of communication to convey and/or obtain information. It is not a Deliverable for Leading per se. However, it is ultimately the manner in which all above Deliverables will be accomplished. Interaction is mostly a two-way form of communication, but can be one-way. Interaction can be through written word, audio, video or a combination of these. The medium used can be multiple: *Mail*, *Chat*, *Meeting* (one-on-one, group meeting, town hall, fireside chat), a printed *Brochure*, *Web page*, etc. Meetings in particular allow a Manager to convey a message not only through verbal, but also through non-verbal communication. Reversely, in Meetings, the Manager has the opportunity to not only get feedback through spoken words but also through body language. This applies for Meetings with individuals as well as crowds. 
Ultimately, a Manager defines how to achieve the various Deliverables and implements those through Interaction.   
  
Leading contributes to the following in Operations: Staff, Groups and Suppliers.
________________________________________
## Controlling
Controlling establishes *how well it was done*. Within Operations, Controlling establishes that the Operations' Results are achieved as per Planning given the Organisation and after Leadership having been applied. Controls are either detective (ex-post) or preventive (ex-ante). The focus of Controlling is on Results within Operations, and can look at the output of a specific Process (including Processes embedded in systems) or more holistically at the overall Result or part thereof of Operations, and anything in between.
...
3. Get *Measurement* of the output of Processes i.e., the Result, including from Processes embedded in Assets;
4. Perform a *Comparison* of Measurement versus Baseline;
...
The Control's Purpose, is fundamental: it sets out what a Control aims to achieve and why that is relevant. A Purpose helps setting the stage for understanding steps 2-6 and, more generally, facilitates the performance of Controls without needing to acquire all background knowledge. This is particularly important for Checks, see below. 
  
The Benchmark is in general defined during the definition of an Objective. The Benchmark establishes *expected* Results from the Objective. Most often, the Benchmark is established during Planning as part of the definition of an Objective. Critically, a well-defined Benchmark sets out one or more alert levels above which specific follow-up actions are expected e.g., info (no action), warning (log event and notify Management) breach (log event, notify Management and define a Remediation action), etc.
   
Depending on the Objective, a Measurement requires a clearly defined Process describing how to measure the outcome of the Objective i.e., how to collect Data, how to create Information from the data to perform the actual Measurement,  etc. 
  
The Comparison of the Measurement versus the Benchmark can be expressed as count, percentage etc. and this can be done in tables, graphs or any format that makes the Comparison easy to interpret. If the Benchmarks were well-defined, the Comparison also highlights clearly if the Measurement has breached one or more alert levels. 
...
Remediation consists of defining actions from the conclusions from the Analysis, possibly including improvement of the Control process itself for example to avoid  False Positives and False Negatives. These actions need integration in Planning, Organising and/or Leading.   
    
Note that above Control logic focuses on Results. It is, however, possible to Control the Input as well as the manner the Result is achieved i.e. the Steps of the Process. In addition, the approach described above can be performed on a granular level as well as a higher level. As such it is possible to perform Controls on Input, the Steps and/or Result of individual Processes, Objectives, or entire Goals. When applied on a granular level it is often called Quality Control.  
...
#### Check 
A Check consists of the full Control cycle described above i.e., understanding the purpose of the Control to be performed, verify the result of a Process against a predetermined threshold and remediate if there is a deviation. This has a strong focus on *avoiding Risk* or *assure Service quality*. Checks can be performed continuously or periodically. Continuous checks are often embedded within an Asset or Routine and are often preventive. Periodic Checks are often detective and performed with a predefined recurrence, and can also verify the *efficiency* of continuous Checks. In most businesses, when the word Control is used, it often means Check in terms of this Management Framework.
...
________________________________________
## Business Functions
Business Functions are fundamental business topics within Operations and more broadly the entire Venture. Even if the core of a Venture are its Operations, a Manager will have to deal with transverse topics that permeate several aspects of Operations and can go outside of it. These topics do not always map or relate to a single aspect of Operations. Yet, being a holistic topic, they may require the POLC approach, particularly in larger Ventures.
  
Typical Business Functions are as follows (in brackets the Profile Tree item or items covered):
...
- Tax (Cost and Risk specifically Tax Evasion and equivalent)
- Procurement (Staff, Suppliers)
- Marketing (Clients, Competitors)
- Communications (Image, Client, Suppliers, Staff, and more broadly Stakeholders)
- Audit (Venture)
  
### Business Functions vs Operations 
In management literature, Operations is often *also* defined as a Business Function, hence the very first entry in above list. In the Management Framework, Operations are considered the core of a Venture, but that approach does not exclude Operations to be also considered a Business Function. After all, it is a category to which the POLC can be applied! There are, however, important differences between Operations and the other Business Functions. Operations define what the Venture is about, what Sector it operates in, the Processes within Operations are entirely different for Ventures in different sectors. For example, the Processes required for mining iron ore are completely different from the processes of transistor manufacturing. Business Functions on the other hand, are more generic. Finance in a mining company will follow similar Processes and metrics as Finance in a transistor manufacturing company, which will follow the same Processes as a shipping company. 
Another, fundamental difference is that Operations generates Revenues. None of the other Business Functions do. Similarly, Operations have outward facing Objectives (to Clients) whereas Business Functions are predominantly inward facing (HR, Finance and Marketing being notable exceptions).
Like Operations, each Business Function has a structure, composed of Processes (Run, Change), Resources (Staff, Suppliers, Assets), Capital (Liabilities, Equity) and Results (Cost, Risk). Note that in Results there is no mention of Revenue as per above. By design the Capital required for each Business Function is likely small, but for the total of Business Functions there may be some Capital required. Lastly, Operations being the revenue generating Business Function, one can consider the other Business Functions support functions to Operations.
...
Ventures having an audit department often do not necessarily consider it a Business Function, but rather an independent organisation within the Venture. In the MF it is considered a Business Function.by the same token, smaller Ventures may not have dedicated departments for some or any Business Function. In that case Managers perform the Business Functions, or they rely on outsourcing or a combination thereof. In small enough Ventures, some Business Functions may not be relevant like Legal or HR (family run business for example).
...
As explained earlier, the POLC are Management *Functions* i.e., like a mathematical function they apply a certain logic on some variables to produce some output or deliverable (put simply). The Business Functions are similar in that they apply some logic to produce an output specific to the topic they are concerned with. However, the logic applied in Business Functions is the POLC! Take for example Business Function Finance. The output of this function is recording and reporting of Financial data (Accounting) and creating the most efficient corporate structure such that Liabilities and Equity are optimally funding Operations (Financing). In order to do this, a Plan needs to be elaborated, Staff need to be organised to perform certain Activities in relation to these Finance topics, they need to be led by someone to achieve the Objectives set out in the plan and there has to be some form of Supervision and reporting to the Managers of the Venture and Stakeholders in the Funding, etc. In other words, the POLC are applied to specific topics of a going concern Venture. 
...
Operations was discussed extensively earlier in this note as the key component of any Venture. Here we focus on some differences on how the scope of Operations in the Management Framework versus other approaches. 
In the Management Framework, Operations contains everything that makes up the day-to-day of a Venture: Processes (Run and Change) being performed by Resources (Staff, Suppliers and Assets), which are funded through Capital (Liabilities, Equity) all yielding Results (both desired: Revenue, and undesired: Cost and Risk). Another way Operations can be looked at is focusing only on the Processes assuming all the other elements are necessary input or output. This approach, focusing only on Processes or 'the things that need doing' is often used in literature (Slack, 2013). In the Management Framework, Operations is larger, but this larger scope does not make the literature invaluable, far from it. Operations Management is a fundamental topic of academic study and is taught notably in most MBA programs. It consists of the principles of Management applied to Operations in other words, it studies how to Plan, Organise and Lead the Operations, and how to Control it. It is worth mentioning that a specific branch of Operations has a strong focus on Processes: Business Process Reengineering, or Business Process Redesign (BPR). The focus of BPR is to fundamentally changing the existing to achieve fundamental improvements in time to market, cost, customer service and general efficiency. 
________________________________________
## Finance
...
### Financing
Financing a.k.a. Corporate Financing is concerned with implementing a corporate structure and Funding that structure. It is this closely related to deliverable of Funding within Organising. It has the following key elements:
...
4. Optimizing the above a.k.a. Capital Management across multiple entities within the Venture see, [## Legal].
...
Skill Management is the function that defines the Skills required to be able to operate within a Group as well as measuring those Skills in prospect and existing Staff. Skills are formalised in the Job Description (see above). Knowledge Management follows similar concepts. 
  
### Training
Training is the process of adding new Skills or Knowledge or improving existing Skills through various means such as to aid in maximising Staff Performance.
  
### Performance Management
Performance Management is the function of measuring performance of Staff versus their potential as well versus Objectives. Objectives are as per the Planning and include both Routines and Projects. An important aspect of Performance Management is reviewing *how* Objectives were achieved and to what extent the Staff is yielding its full potential. 
...
### Applications
Applications are the software that aid the Venture directly or indirectly in producing the Services. There are different ways of approaching Applications, but a simple structure is to divide Applications in two broad categories:
- Supplied Applications
- In-house Applications
   
The former includes all off-the-shelf software i.e. software that is not part of the core Services of the Venture or which are so common that they would not lead to a competitive edge. In-House applications concerns software that contributes directly or indirectly to the Services and either may have a competitive edge and/or has features that cannot be found in off-the-shelf software. Applications also include Artificial Intelligence or any of its derivatives. 
________________________________________
## Risk
...
________________________________________
## Compliance
Compliance is concerned with the assessment of adherence to rules and regulations imposed by the Environment on specific Sectors as well as adherence to internal rules and regulations. Compliance is thus concerned with a specific form of Risk discussed earlier under [## Operations]: Regulatory Risk. Regulations are defined by regulators often to protect individuals or groups in society and can involve different types of protection, ultimately all geared towards the protection of individuals:
...
### Legal Opinions
In case of contractual matters Legal is asked to provide an Opinion of the impact of the contract.

### Litigation
Although not desirable, it is entirely possible that the Venture is subject to some form of litigation. Such litigation can be initiated by any Stakeholder.

### Entity Structure Management
The Venture is incorporated under some legal structure, and if the Venture is a large one, different legal entities may be involved. 
________________________________________
## Tax
...
Depending on the type of Supplier there can be regulatory or legal implications. In most cases a legal agreement needs to be drafted which requires the help of Legal.  During the lifetime of the Supplier, updates to existing agreements may occur for example because the scope of Services is increased. 
Offboarding is the reverse, and can include an Onboarding if the Supplier needs to be replaced.  
  
### Purchase Management 
Purchase Management's main focus is the actual purchase of Assets and Services and payment to Suppliers once they are onboarded. It also includes reporting of Costs and actual benefits obtained to Management. In large Ventures the Purchase Management activity can be very elaborate with dedicated Staff and Assets like Purchase Software, and Software tracking deliveries made by Suppliers, particularly.  
________________________________________
## Marketing 
Both Marketing and Communications deal with communicating to Stakeholders. They differ in the target groups. Marketing is the Business Function concerned with intentionally stimulating demand for and purchase of Goods and Services produced through Operations for existing or future Clients. It includes defining target *Clients*, attracting them and retaining them. Defining Clients involves establishing the Services and/or Products the Clients desire/need as well as pricing those Services/Products and establishing how to advertise the Venture's capabilities to deliver the Services/Products in a manner optimal for the Client. From a Management perspective the Sales activity is part of Marketing. In many cases, Sales and/or Marketing are considered Activities instead of Business Functions. 
...
________________________________________
## Communications
Communications is the Business Function occupied with the Reputation of the Venture and the general brand name awareness both external and internal.   
________________________________________
## Audit
...
The former is often used for ongoing review within above focus points. The latter is often called in for specific topics. One recurring use of External Audit is the yearly so called Statutory Audit of the Finances of a Venture (for listed companies). External auditors are deemed a Supplier and thus fall within Supplier Management, see above.  
________________________________________
## Management Cycle
The foundational concepts of the Profile Tree as well as the Deliverables within Management (POLC, Business Functions, Tools) help a Manager structure the various aspects involved in Management. Each aspect of the Deliverables helps the Manager to understand the fundamental building blocks of Management.
  
The *practical implementation* of these theoretical concepts is performed through a continuous iterative process, referred to as the *Management Cycle*. When the terms "Management" or "Managing" are used, it refers at the same time to the theoretic concepts of POLC, Business Functions and Tools, as well as the implementation of it through the Management Cycle. 
   
At this point it is worthwhile providing an illustration of how the Management Cycle applies. As an example consider the production of Financial Statements. Such statements need to be produced at specific intervals (Planning) either because of some legal obligations under some corporate law (Legal) and/or because of regulations (Compliance). These requirements can also change over time which requires regular review of those obligations (Intel). There are often requirements as to the auditability of the statements (Audit) as well as the production of the data from the various systems (Operations) into accounting statements (Finance - Accounting) needs to be reviewed by relevant staff with the skills to do so (HR - Skill & Knowledge) and the results needs to undergo a Review including validation or certification (Controlling, Finance - Accounting) including by an independent external auditor (Procurement) and there may be deadlines that require people to readjust current priorities (Leading). The entire structure to do this on a recurring basis needs to be maintained and adapted over time (Organising). There is likely a need to frame such entire setup in a Framework and possibly specific Procedures (Tools). The total of it should be maintained in an Operational Plan (Planning). The list can go on in more details covering more aspects. The net result of the above is the audit approved financial statements, which is something that falls within Accounting. 

This simple example shows that a Manager needs to mix various aspects of Management for a given Topic. It also shows that this done on a *recurring basis* or a *cycle*, in other words through Routines dedicated to Management! Lastly, it shows the Manager needs to have a broad range of Skills & Knowledge to be able to perform Management effectively. 
  
Depending on the Management Level a Manager thus performs various Routines at different frequencies as part of the Management Cycle. For example, a Manager can assess the Objectives, Activities and Groups applicable to the Venture on a recurring basis, but he may not need to spend any time, if at all, on redefining the Mission or Values of a Venture. Similarly, the four types of Supervisory Processes (Check, Review, Attend, Audit), yield recurring Routines. In most cases the Manager meets Staff and Suppliers to Lead and other Stakeholders to Report. Because of this, the Management Cycle has no prescribed deliverables. However, the following reflect typical Routines the Manager may perform in the Management Cycle:
- Plan (generic Routine for anything related to POLC function "Planning")
- Organise (generic Routine for anything related to POLC function "Organising")
- Lead (generic Routine for anything related to POLC function "Leading")
- Control (generic Routine for anything related to POLC function "Controlling")
- Check (specific Routine related to Controlling deliverable Supervision)
- Review (specific Routine related to Controlling deliverable Supervision)
- Attend (specific Routine related to Controlling deliverable Supervision)
- Report (specific Routine related to Controlling deliverable Supervision)
- Monitor  (specific Routine related to Controlling deliverable Supervision)
- Meet (specific Routine related to Leading deliverable Interaction)
- Maintain (generic Routine applicable to all Management Functions and Business Functions).
- etc
   
The notion of the generic Routine "Maintain" reflects the complexity of the something that is to be maintained i.e., to define, initiate, document, organise and regularly review something. It can be applied to individual Deliverables e.g., "Maintain SWOT", "Maintain Roles & Responsibilities", "Maintain Management Improvement", etc. It can *also* be applied to a blend of Deliverables that apply to a specific Topic. The above "Maintain Financial Statements" is a good example.
Similarly, "Meet ..." as in "Meet someone" reflects various Deliverables under Leading, but it can also include aspects of other Deliverables within Management, like for example "Plan", "Review" and "Monitor" of that "someone". 
   
In conclusion, the last Management Deliverable, Management Cycle consists of many Routines performed by a Manager across a blend of one or more Management Deliverables as part of an ongoing process that yields what is expected from this Framework: Management.  
...
Fayol, H. (1949), General and Industrial Management (translated from "Administration industrielle et générale" (1916), by Constance Storrs). Sir Isaac Pitman & Sons.
...
Poff, R. Skripak, P. (2023) Fundamentals of Business. https://doi.org/10.21061/fundamentalsofbusiness4e. Pamplin college of business in association with Virginia Tech Publishing.
...
Slack N., Brandon-Jones, A., Johnston, R. (2013) Operations Management (7th edition). Prentice Hall.  
...
### 20251026
- Updated [#### Personality] with more traits + moved some aspects from [#### Soft-skills] 
- Added {### Management Principles]
- Added more differences in [### Business Functions vs Operations]
- Added [## Operations (revisited)
  
### 20251031
- Updated several sections with clearer language and corrected some typos.
  
### 20251128
- Reintroduced the Management Cycle as a deliverable in [## Profile Tree], [## Profile Tree Executive Summary] and [## Management] 
- Added details of this new deliverable in [## Management Cycle]
  
### 20260125
- Updated [### Topic Definition] and moved it earlier in [## Tools] 
  
### 20260204
- Removed the footnotes from Profile Overview.
  
### 20260218
- Added Image in the Results of Operations and added [### Image]
   
### 20260222
- Updated [### Image], [### Change] in [## Processes]
  
### 20260303
- Added [### Culture]
   
### 20260307
- Added [## Management and Span of Control]
  
### 20260322  
- Updated [### Objectives]
- Updated [### Funding] to include the decision to *not* Fund.
- Added [### Interaction] as a deliverable for Leading opening the door to the use of Chat, Mail, Meet as Routines for Management Cycle. 
- Updated [## Management Cycle] 
